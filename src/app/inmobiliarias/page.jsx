      ...
      <div className="overflow-y-auto overflow-x-hidden h-[100vh] scrollbar relative z-10">
        ...
        >
          ...
          <NavbarContent className="hidden sm:flex gap-6" justify="center">
            ...
            <NavbarItem>
              <Link className="text-primary font-medium hover:text-primary transition-colors" href="/inmobiliarias">
                Inmobiliarias
              </Link>
            </NavbarItem>
            <NavbarItem>
          ...
          <NavbarMenu className="bg-[#02121B]/95 backdrop-blur-md border-t border-white/10">
            ...
            <NavbarMenuItem>
              <Link className="w-full text-primary py-2 border-b border-white/5 hover:text-primary transition-colors" href="/inmobiliarias" size="lg">
                Inmobiliarias
              </Link>
            </NavbarMenuItem>
            <NavbarMenuItem>
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] py-12 md:py-20 w-full mx-auto relative overflow-hidden">
          ...
          >
            ...
            >
              {"Vende proyectos y lotes más rápido con ".split(" ").map((word, i) => (
                <motion.span
                  key={i}
                  variants={{
          ...
          {[
            {
              ...
              desc: "Tus lotes y parcelaciones abiertos a visitas interactivas las 24 horas del día. Ahorra tiempo en traslados innecesarios y filtra prospectos con real interés."
            },
            {
            ...
            },
            {
              ...
              desc: "Destácate frente a la competencia con tecnología de vanguardia. Un marketing inmersivo 3D genera confianza, seriedad y una experiencia de usuario memorable."
            }
          ].map((item, index) => (
            <motion.div
              key={index}
            ...
            >
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="flex items-center gap-3">
                  ...
                  <span>Delineación clara de linderos e hitos.</span>
                </li>
                <li className="flex items-center gap-3">
                  <Check className="text-secondary w-4 h-4 flex-shrink-0" />
                  <span>Panorámicas 360° reales del entorno y vecindario.</span>
                </li>
                <li className="flex items-center gap-3">
                  <Check className="text-primary w-4 h-4 flex-shrink-0" />
                  <span>Fácil compartición por enlace en WhatsApp y redes sociales.</span>
                </li>
              </ul>
            </motion.div>
          </div>

...
const ModalNewProject = ({
  ...
  return (
    <div className="hola mundo h-[100vh]">
      <Modal
        backdrop={"blur"}
        placement="center"
        size="xl"
                ...
                <Formik
                  ...
                  onSubmit={async (values) => {
                    ...
                    for (const i in values)
                      if (i !== "dateInit") formData.append(i, values[i]);
                        ...
                        {({ field, meta }) => (
                          <div>
                            ...
                            <div className="mb-[15px] mt-[5px]">
                              <p className="h-[1rem] text-sm  text-[#FD6358]">
                      ...
                      >
                        {({ getRootProps, getInputProps }) => (
                          ...
                          >
                            <div
                              {...getRootProps()}
                              className="cursor-pointer border-dashed border-2 border-gray-300 rounded-lg p-8 text-center"
                            >
                              <input {...getInputProps()} />
                              {imgOfProject.length > 0 ? (
                                ...
                                <p>
                                  {isValidImg
                                    ...
                                    : "Tipo de archivo invalido, deben ser (.png)"}
                                </p>
                              )}
                            </div>
                          </section>

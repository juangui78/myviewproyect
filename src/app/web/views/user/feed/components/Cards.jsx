  ...
  return (
    <>
      <div className="w-full flex flex-col items-center">
        <div className="w-[95%] xl:w-[85%] 2xl:w-[75%] max-w-[1800px] flex justify-between items-center text-white/80 mt-2 px-4">
          <span className="text-sm font-semibold bg-[#1A1F26]/60 backdrop-blur-xl border border-white/10 px-4 py-2 rounded-2xl shadow-lg">
            Total de Proyectos: <span className="text-[#0CDBFF] font-bold text-base ml-1">{totalProyects || 0}</span>
          </span>
        </div>

        <div
          className="grid grid-cols-1 lg:grid-cols-2 gap-10 w-[95%] xl:w-[85%] 2xl:w-[75%] max-w-[1800px] mt-6 px-4 mb-[80px] relative"
        >
          {proyects.length > 0 ? (
            proyects.map((item) => {
              return (
